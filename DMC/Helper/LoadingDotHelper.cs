...
namespace DMC.Helper
{
    ...
    /// 表示一个"点"
    /// </summary>
    internal sealed class LoadingDotHelper
    {
        #region 字段/属性
        ...
        [Description("点相对于圆心的角度，用于计算点的绘图坐标")]
        private int _angle;
        [Description("透明度")]
        ...
        public LoadingDotHelper(PointF circleCenter, float circleRadius)
        {
            Reset();
